...
module.exports.DigimonQualities = {
	...
	"Combat Awareness III": {tags: ["A"], cost: 1, maxRanks: false, desc: "Add your Ranks in Combat Awareness to your Accuracy for the first round of Combat. The Digimon treats Surprise Rounds triggered against it as a normal round of combat.", prereqs: {"Combat Awareness II": 1}, unlocks: [], handler: "ability" },
