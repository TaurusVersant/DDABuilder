...
module.exports.DigimonQualities = {
	...
	"Data Optimization - Speed Striker": {tags: ["S"], cost: 1, maxRanks: false, desc: "The Digimon gains a +3 bonus to its Base Movement score, but takes a -1 Dodge penalty.", unlocks: ["Data Specialization - Hit and Run", "Data Specialization - Uncatchable Target", "Hybrid Drive - Speed Striker Adjacent"], handler: "dataOpt", statMods: { BaseMovement: 3, Dodge: -1 } },
