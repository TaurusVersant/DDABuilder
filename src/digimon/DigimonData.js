...
module.exports.DigimonQualities = {
	...
	"Selective Targeting": {tags: ["S"], cost: 3, maxRanks: false, desc: "The Digimon’s [Area] tagged Attacks will no longer be able to Damage Allies or place negative Effects on them such as Poison, Weaken, or Blind. Inversely, enemies the Digimon attacks will not be able to gain benefits from positive Effects such as Shielding, Strengthen, or Cleanse. Allies now only roll ½ of their normal Dodge in response to a Positive Effect. This does not apply if the Attack has a single target.", unlocks: [], handler: "ability" },
